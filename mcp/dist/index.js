...
var API_BASE = process.env.BTCFI_API_URL || "https://btcfi.aiindigo.com";
var PAYMENT_NETWORK = process.env.PAYMENT_NETWORK || "base";
function getToolPrice(endpoint) {
...
function getToolCategory(endpoint) {
